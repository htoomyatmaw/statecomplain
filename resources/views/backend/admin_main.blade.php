        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">User Complaints</h3><!-- /.menu-title -->

                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>New Complaints </a>
                    </li>
                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Solved Complaints </a>
                    </li>
                   
                    <h3 class="menu-title">Users</h3><!-- /.menu-title -->
                  
                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-users"></i>User List </a>
                    </li>
                    <li>
                        <a href="index.html"> <i class="menu-icon fas fa-money-bill-wave"></i>User Billing </a>
                    </li>

                    <h3 class="menu-title">Township/Quarter</h3><!-- /.menu-title -->
                  
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Township</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-basic.html">Township List</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Add Township</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Quarter</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-basic.html">Quarter List</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="forms-advanced.html">Add Quarter</a></li>
                        </ul>
                    </li>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light">User Billing</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-3">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light">New Complaints</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-4">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light">Solved Complaints</p>
